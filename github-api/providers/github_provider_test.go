...
func TestCreateRepoNoError(t *testing.T) {
	...
	restclient.AddMockup(restclient.Mock{
		...
		Response: &http.Response{
			StatusCode: http.StatusCreated,
			Body:       ioutil.NopCloser(strings.NewReader(`{"id": 123,"name": "golang-tutorial","full_name": "rwehresmann/golang-tutorial"}`)),
		},
	})
	...
	assert.EqualValues(t, "rwehresmann/golang-tutorial", response.FullName)
}
